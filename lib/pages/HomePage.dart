...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Consumer2<HomeProvider, MainProvider>(
        builder: (homeContext, homeProvider, mainProvider, child) {
      return SingleChildScrollView(
        child: Visibility(
          visible: mainProvider.currentPage == PageState.HOME,
          child: Opacity(
